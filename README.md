...
You can deploy the frontend to Vercel and proxy API calls to an externally hosted backend.

1. In the Vercel dashboard create a new project from this repository.
2. Vercel will detect the `frontend/package.json` and run `npm run build` automatically.
