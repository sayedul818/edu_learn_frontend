      ...
      <div className="relative overflow-hidden rounded-2xl border border-border/70 bg-gradient-to-r from-card via-card to-muted/60 p-5 shadow-lg md:p-6">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-2 mb-3">
            ...
            <span className="text-xs font-semibold text-primary">Self Test</span>
          </div>
          
          {/* Main heading */}
          <h1 className="text-3xl font-display font-bold text-foreground mb-1">Self Test</h1>
          
          {/* Description */}
          <p className="text-muted-foreground text-sm">Create a custom practice exam and start focused preparation.</p>
        </div>
      </div>
