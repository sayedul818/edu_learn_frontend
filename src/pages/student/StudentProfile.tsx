        ...
        <div className="relative flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs text-primary">
              <Sparkles className="h-3.5 w-3.5" /> Student Profile
            </p>
            <h1 className="mt-3 text-2xl font-bold text-foreground">Manage Your Profile</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Update your academic and account settings with live backend sync.
            </p>
          </div>

          <div className="rounded-xl border border-border/60 bg-background/60 px-4 py-3 text-sm text-muted-foreground backdrop-blur">
            <p>Role</p>
            <p className="text-foreground">Student</p>
          </div>
        </div>
      </div>
