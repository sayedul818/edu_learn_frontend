      ...
      <div className="rounded-2xl border border-slate-300 dark:border-cyan-500/20 bg-slate-100 dark:bg-slate-900 p-5 shadow-xl overflow-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-slate-400 dark:border-cyan-500/30 bg-slate-200/50 dark:bg-cyan-500/10 px-4 py-2 mb-3">
            ...
            <span className="text-xs font-semibold text-slate-700 dark:text-cyan-300">Student Assignment Center</span>
          </div>
          
          {/* Main heading */}
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-1">Assignments</h1>
          
          {/* Description */}
          <p className="text-slate-700 dark:text-slate-300 text-sm">{selectedCourse ? `Assignments for ${selectedCourse.courseTitle}` : "Complete your assignments, track submissions, and receive feedback from your teachers."}</p>
        </div>
      </div>
